...
WEIGHTS_PATH = ('https://storage.googleapis.com/tensorflow/'
                +'keras-applications/resnet/resnet50_weights_tf_dim_ordering_tf_kernels.h5')
# WEIGHTS_PATH_NO_TOP = ('https://modelarts-competitions.obs.cn-north-1.myhuaweicloud.com/'
#                        'model_zoo/resnet/'
#                        'resnet50_weights_tf_dim_ordering_tf_kernels_notop.h5')

WEIGHTS_PATH_NO_TOP = ('https://storage.googleapis.com/tensorflow/keras-applications/'
