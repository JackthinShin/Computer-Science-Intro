...
CLASS_INDEX_PATH = ('https://modelarts-competitions-bj4.obs.cn-north-4.myhuaweicloud.com/'
                    'model_zoo/resnet/imagenet_class_index.json')
...
WEIGHTS_PATH_NO_TOP = ('https://modelarts-competitions-bj4.obs.cn-north-4.myhuaweicloud.com/'
                        'model_zoo/resnet/'
                       'resnet50_weights_tf_dim_ordering_tf_kernels_notop.h5')
